		...
		<div class="wrap">
			<div class="row">
				<ul class="product-head">
					...
					<li  class="active-page"><a href="<?ROOT?>/aromacatalog/">Аромки</a></li>
					<div class="clear"> </div>
				</ul>
					...
					<div class="product-grids">
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a href="/aromavape/<?php echo $categoryItem['id'];?>"><img src=<?ROOT?>"<?=$categoryItem['image']?>" title="<?=$categoryItem["name"]?>" alt="<?=$categoryItem["name"]?>"/></a>
								<p>
								<span><a href="/aromavape/<?php echo $categoryItem['id'];?>"><?php echo $categoryItem['name'];?></a></span>
								</p>
							</div>
							...
							<div class="product-info">
								<div class="product-info-cust">
									<a href="/aromavape/<?=$categoryItem["id"]?>">Подробнее</a>
								</div>
								<div class="clear"> </div>
							</div>
