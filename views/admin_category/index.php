			...
			<table class="table-bordered table-striped table">
				...
				<?php foreach($categoryList as $category): ?>
					<tr>
						...
						<td><a href="/admin/category/update/<?php echo $category['id']; ?>" title="Редактировать"><i class="fa fa-pencil-square-o">Редактировать</i></a></td>
						<td><a href="/admin/category/delete/<?php echo $category['id']; ?>" title="Удалить"><i class="fa fa-times">Удалить</i></a></td>
					</tr>
				<?php endforeach;?>
			</table>
		</div>
