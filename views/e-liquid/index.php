		...
		<div class="wrap">
			<div class="row">
				<ul class="product-head">
					...
					<li  class="active-page"><a href="<?ROOT?>/eliquid/">E-liquid</a></li>
					<div class="clear"> </div>
				</ul>
					...
					<div class="product-grids">
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a href="/eliquidvape/<?php echo $categoryItem['id'];?>"><img src=<?ROOT?>"<?=$categoryItem['image']?>" title="<?=$categoryItem["name"]?>" alt="<?=$categoryItem["name"]?>"/></a>
								<p>
								<!-- <a href="/aromavape/<?php echo $categoryItem['id'];?>"><small><?=$categoryItem["brand"]?></small> <?=$categoryItem["name"]?> <small>Phantom</small> FG</a> -->
								<span><a href="/eliquidvape/<?php echo $categoryItem['id'];?>"><?php echo $categoryItem['name'];?></a></span>
								</p>
							</div>
							...
							<div class="product-info">
								<div class="product-info-cust">
									<a href="/eliquidvape/<?=$categoryItem["id"]?>">Подробнее</a>
								</div>
								<div class="clear"> </div>
							</div>
